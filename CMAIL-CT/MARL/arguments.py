...
def get_args():
    ...
    # environment
    parser.add_argument('--env-name', default='simple_line', help='one from {simple_spread, simple_formation, simple_line})')
    ...
    # PPO
    parser.add_argument('--algo', default='acktr', help='algorithm to use: a2c | ppo | acktr')
